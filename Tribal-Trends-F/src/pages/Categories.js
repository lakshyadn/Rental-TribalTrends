...
const Categories = () => {
  const products = [
    ...
    { id: 2, name: 'Casual T-Shirt', price: 19.99, image: 'https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcTTPngl-TqJ2_u3QPio4I5OSZiTf7wWihhw3_4WZePvVIfACnAFFdsWgC5uXdlsJfrOFcCe7CFHnTpMIN09GVrTbxPFpmNMBKBdxdwh8HL4EJXxdncyU5vgvQ', category: 'Tops' },
